...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ElTreeSelect_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("71bb");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ElTreeSelect_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ElTreeSelect_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ElTreeSelect_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// load the styles
var content = __webpack_require__("5fff");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("1c8c2436", content, true, {"sourceMap":false,"shadowMode":false});
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"78b3e0be-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/src/ElTreeSelect.vue?vue&type=template&id=23216153&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"el-tree-select",class:_vm.selectClass},[_c('el-select',_vm._b({directives:[{name:"popover",rawName:"v-popover:popover",arg:"popover"}],ref:"select",staticClass:"el-tree-select-input",style:(_vm.styles),attrs:{"id":'el-tree-select-' + _vm.guid,"disabled":_vm.disabled,"popper-class":"select-option","popper-append-to-body":false,"filterable":false,"multiple":_vm.selectParams.multiple,"title":_vm.labels},on:{"remove-tag":_vm._selectRemoveTag,"clear":_vm._selectClearFun,"focus":_vm._popoverShowFun},model:{value:(_vm.labels),callback:function ($$v) {_vm.labels=$$v},expression:"labels"}},'el-select',_vm.selectParams,false)),_c('el-popover',{ref:"popover",attrs:{"placement":_vm.placement,"transition":_vm.transition,"popper-class":_vm.popperClass,"width":_vm.width,"trigger":"click"},model:{value:(_vm.visible),callback:function ($$v) {_vm.visible=$$v},expression:"visible"}},[(_vm.treeParams.filterable)?_c('el-input',{staticClass:"input-with-select mb10",attrs:{"size":"mini"},on:{"change":_vm._searchFun},model:{value:(_vm.keywords),callback:function ($$v) {_vm.keywords=$$v},expression:"keywords"}},[_c('el-button',{attrs:{"slot":"append","icon":"el-icon-search"},slot:"append"})],1):_vm._e(),_c('el-scrollbar',{staticClass:"is-empty",attrs:{"tag":"div","wrap-class":"el-select-dropdown__wrap","view-class":"el-select-dropdown__list"}},[_c('el-tree',_vm._b({directives:[{name:"show",rawName:"v-show",value:(_vm.data.length > 0),expression:"data.length > 0"}],ref:"tree",attrs:{"data":_vm.data,"node-key":_vm.propsValue,"draggable":false,"current-node-key":_vm.ids.length > 0 ? _vm.ids[0] : '',"show-checkbox":_vm.selectParams.multiple,"filter-node-method":_vm.filterNodeMethod ? _vm.filterNodeMethod : _vm._filterFun,"render-content":_vm.treeRenderFun},on:{"node-click":_vm._treeNodeClickFun,"check":_vm._treeCheckFun}},'el-tree',_vm.treeParams,false)),(_vm.data.length === 0)?_c('div',{staticClass:"no-data"},[_vm._v("暂无数据")]):_vm._e()],1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/src/ElTreeSelect.vue?vue&type=template&id=23216153&
...
function getTreeData(data) {
  ...
  var isRow = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : false;
  var arr = [];
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/src/ElTreeSelect.vue?vue&type=script&lang=js&
...
/* harmony default export */ var ElTreeSelectvue_type_script_lang_js_ = ({
  name: 'el-tree-select',
  props: {
    ...
    value: function value(val) {
      if (this.ids !== val) {
        ...
        if (this.selectParams.multiple) {
          this.ids = _toConsumableArray(val);
        } else {
          this.ids = val === '' ? [] : [val];
        }
      }
  ...
  computed: {
    popperClass: function popperClass() {
      var _c = 'el-tree-select-popper ' + this.popoverClass;

      return this.disabled ? _c + ' disabled ' : _c;
    }
  },
  created: function created() {
    var _this$treeParams = this.treeParams,
        props = _this$treeParams.props,
        data = _this$treeParams.data,
        leafOnly = _this$treeParams.leafOnly,
        includeHalfChecked = _this$treeParams.includeHalfChecked;
    ...
    this.data = data.length > 0 ? _toConsumableArray(data) : [];
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      on(document, 'mouseup', _this2._popoverHideFun);
    });
  },
  methods: {
    // 根据类型判断单选，多选
    _setMultipleFun: function _setMultipleFun() {
      var multiple = false;
    ...
    //  根据id筛选当前树名称，以及选中树列表
    _setSelectNodeFun: function _setSelectNodeFun(ids) {
      var _this3 = this;
      ...
      var multiple = this.selectParams.multiple; // 长度为0，清空选择
      ...
      if (multiple) {
        ...
        el.getCheckedNodes(this.leafOnly, this.includeHalfChecked).forEach(function (item) {
          el.setChecked(item, false);
        });
        ids.forEach(function (id) {
          el.setChecked(id, true);
        });
        var nodes = el.getCheckedNodes(this.leafOnly, this.includeHalfChecked);

        if (this.propsCode) {
          // 如果有code   labels=code(name)
          this.labels = nodes.map(function (item) {
            return item[_this3.propsCode] ? item[_this3.propsLabel] + '(' + item[_this3.propsCode] + ')' : item[_this3.propsLabel];
          }) || [];
        } else {
          this.labels = nodes.map(function (item) {
    ...
    // 更新popover位置
    _updatePopoverLocationFun: function _updatePopoverLocationFun() {
      var _this4 = this;
    ...
    _getEventPath: function _getEventPath(evt) {
    ...
    _treeNodeClickFun: function _treeNodeClickFun(data, node, vm) {
      ...
      var clickParent = this.treeParams.clickParent;
      var checkStrictly = this.treeParams['check-strictly'];
      var propsValue = this.propsValue,
          propsChildren = this.propsChildren,
          propsDisabled = this.propsDisabled;
      var children = data[propsChildren] || [];
      ...
      if (node.checked) {
        ...
        if (!checkStrictly && children.length) {
          children.forEach(function (item) {
            _this5.ids = _this5.ids.filter(function (id) {
              return id !== item[propsValue];
            });
          });
        }
      } else {
        if (!multiple) {
          ...
          if (!clickParent && children.length === 0) {
            ...
            // 允许点击父级
            this.ids.push(data[propsValue]); // 如果父子关联，将子节点push进勾选项

            if (!checkStrictly && children.length) {
              children.forEach(function (item) {
                _this5.ids.push(item[propsValue]);
              });
            }
          }
        }
    ...
    // 树勾选
    _treeCheckFun: function _treeCheckFun(data, node, vm) {
      var _this6 = this;

      this.ids = [];
      var propsValue = this.propsValue;
      node.checkedNodes.forEach(function (item) {
        _this6.ids.push(item[propsValue]);
      });
      /*
    ...
    // 下拉框移除tag时触发
    _selectRemoveTag: function _selectRemoveTag(tag) {
      var _this7 = this;

      var data = this.data,
          propsValue = this.propsValue,
          propsLabel = this.propsLabel,
          propsChildren = this.propsChildren;
      each(data, function (item) {
        if (item[propsLabel] === tag) {
          var value = item[propsValue];
          _this7.ids = _this7.ids.filter(function (id) {
            return id !== value;
          });
        }
      }, propsChildren);
    ...
    _selectClearFun: function _selectClearFun() {
      this.ids = [];
      var multiple = this.selectParams.multiple; // 下拉框清空，对外抛出``this.$emit('input', multiple ? [] : '');`

      this.$emit('input', multiple ? [] : ''); // 下拉框清空，对外抛出``this.$emit('select-clear');`
    ...
    _updateH: function _updateH() {
      ...
      this.$nextTick(function () {
        _this8.width = _this8.$refs.select.$el.getBoundingClientRect().width;
      });
    },
    // 显示弹出框的时候容错，查看是否和el宽度一致
    _popoverShowFun: function _popoverShowFun(val) {
      this._updateH();
    },
    // 判断是否隐藏弹出框
    _popoverHideFun: function _popoverHideFun(e) {
      var path = this._getEventPath(e);

      var isInside = path.some(function (list) {
        // 鼠标在弹出框内部，阻止隐藏弹出框
    ...
    treeDataUpdateFun: function treeDataUpdateFun(data) {
      ...
      this.data = data; // 数据更新完成之后，判断是否回显内容

      if (data.length > 0) {
        setTimeout(function () {
          _this9._setSelectNodeFun(_this9.ids);
        }, 300);
      }
    },
     ...
     * @arg String
     */
    filterFun: function filterFun(val) {
...
// CONCATENATED MODULE: ./src/components/src/ElTreeSelect.vue?vue&type=script&lang=js&
 /* harmony default export */ var src_ElTreeSelectvue_type_script_lang_js_ = (ElTreeSelectvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./src/components/src/ElTreeSelect.vue?vue&type=style&index=0&lang=css&
var ElTreeSelectvue_type_style_index_0_lang_css_ = __webpack_require__("3414");
...
// CONCATENATED MODULE: ./src/components/src/ElTreeSelect.vue
...
var component = normalizeComponent(
  src_ElTreeSelectvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var ElTreeSelect = (component.exports);
// CONCATENATED MODULE: ./src/components/src/index.js
...
/* harmony default export */ var src = (ElTreeSelect);
...
var Components = [src]; // 定义 install 方法
